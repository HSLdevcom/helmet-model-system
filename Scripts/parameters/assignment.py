...
roadclasses = {
    21: RoadClass("motorway", 1, 2100+100, 113, 0.265, 0.10),
    23: RoadClass("motorway", 1, 2000+100, 97, 0.309, 0.10),
    25: RoadClass("motorway", 1, 2000+100, 81, 0.370, 0.10),
    26: RoadClass("motorway", 1, 1900+100, 73, 0.411, 0.10),
    27: RoadClass("highway", 2, 1900, 97, 0.309, 0.05),
    29: RoadClass("highway", 2, 1850, 81, 0.370, 0.05),
    31: RoadClass("highway", 2, 1600, 73, 0.411, 0.03),
    32: RoadClass("highway", 2, 1600, 63, 0.556, 0.03),
    33: RoadClass("arterial", 3, 1450, 61, 0.492, 0.02),
    34: RoadClass("arterial", 3, 1250, 54, 0.556, 0.02),
    35: RoadClass("arterial", 4, 1150, 48, 0.625, 0.01),
    36: RoadClass("arterial", 4, 1000, 44, 0.682, 0.01),
    37: RoadClass("arterial", 4, 1000, 41, 0.732, 0.01),
    38: RoadClass("collector", 5, 900, 41, 0.732, 0.00),
    39: RoadClass("collector", 5, 750, 36, 0.833, 0.00),
    40: RoadClass("collector", 5, 900, 36, 0.833, 0.00),
    41: RoadClass("local", 5, 600, 30, 1.000, 0.00),
    42: RoadClass("local", 5, 500, 12, 1.304, 0.00),
    43: RoadClass("collector", 5, 750, 30, 0.833, 0.00),
}
