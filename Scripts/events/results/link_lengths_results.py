...
class LinkLengthResults(ModelSystemEventListener):
    """
    A class to analyze link categories by total length.
    """
    ...
    def on_daily_results_aggregated(self, assignment_model, day_network, network_aggregations):
        linklengths = network_aggregations["linklengths"]
        self.ms.resultdata.print_data(linklengths, "link_lengths.txt", "length")