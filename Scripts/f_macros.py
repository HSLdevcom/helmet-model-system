...
class f_macros(_m.Tool()):
    ...
    expr_x91_x95 = '(type-190)*(type.ge.191)*(type.le.195)+(type-290)*(type.ge.291)*(type.le.295)+' +
	...
	# ** poistetaan mahdollisen bussikaistan funktiomaarittely
	...
	if tp = 'aht':
		...
		capas_type  = 'all'
		ttf_tram = '4'
		display('time period ', tp, ' not recognized')
	...
	# tahan valiin bussikaistattomat makroista 4
